...
public class NewVideoPostActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_video_post);
    ...
    public void onClick(View view) {
        ...
        if (inputText.getText().toString().trim().isEmpty() || postName.getText().toString().trim().isEmpty()) {
            Toast.makeText(NewVideoPostActivity.this, "Please ensure post is not empty",
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    ...
                    if (ActivityCompat.checkSelfPermission(NewVideoPostActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        fusedLocationClient.getLastLocation()
                                .addOnSuccessListener(NewVideoPostActivity.this, new OnSuccessListener<Location>() {
                                    @Override
                                    public void onSuccess(Location location) {
                                        ...
                                        Toast.makeText(NewVideoPostActivity.this, "Post was successfully added",
                                                Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(NewVideoPostActivity.this, SubforumActivity.class);
                        ...
                        ActivityCompat.requestPermissions(NewVideoPostActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION},44);
                        Toast.makeText(NewVideoPostActivity.this, "Please allow location access and try again",
                                Toast.LENGTH_SHORT).show();
                    }
